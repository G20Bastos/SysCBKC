<%@ Page Title="Gerenciar conta" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="Account_Manage" %>
            ...
            <section id="passwordForm">
                <asp:PlaceHolder runat="server" ID="setPassword" Visible="false">
                    ...
                    <div class="form-horizontal">
                        <h4>Definir formulário da senha</h4>
                        <hr />
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    <p>Conectado como <strong><%: User.Identity.GetUserName() %></strong>.</p>
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="ConfirmNewPassword"
                                    CssClass="text-danger" Display="Dynamic" ErrorMessage="Confirmar a nova senha é obrigatório."
                                    ValidationGroup="ChangePassword" />
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <asp:Button runat="server" Text="Alterar senha" OnClick="ChangePassword_Click" CssClass="btn btn-default" ValidationGroup="ChangePassword" />
                            </div>
                        </div>
                    </div>
                </asp:PlaceHolder>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button runat="server" Text="Remover" CommandName="Delete" CausesValidation="false"
                                    ToolTip='<%# "Remover isso " + Item.LoginProvider + " logon de sua conta" %>'
