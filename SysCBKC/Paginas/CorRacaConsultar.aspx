<%@ Page Language="C#" MasterPageFile="~/Paginas/MasterPage.master" AutoEventWireup="true" CodeFile="CorRacaConsultar.aspx.cs" Inherits="Paginas_CorRacaConsultar" %>
      ...
      <div class="card">
          ...
          <div class="container-fluid box">
              <div class="card-header">
                <h5 class="card-title">Cores de Raças</h5>
              </div>
            ...
            <div class="form-group col-6">
                ...
                <asp:TextBox ID="txtVariedadeRaca" CssClass="form-control" MaxLength="200" style='text-transform:uppercase' runat="server"></asp:TextBox>
                       ...
                       <div class="form-group col-3">
                                ...
                                <asp:DropDownList ID="drpRaca" runat="server" CssClass="form-control" OnSelectedIndexChanged="drpRaca_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </div>
                 <div class="form-group col-3">
        ...
        <div class="row">
            <div class="col">
                <asp:GridView ID="dtgCorRaca" Width="100%" runat="server" AllowPaging="True" CssClass="table table-striped table-bordered table-hover table-padrao" PageSize="30"
                    OnRowDataBound="dtgCorRaca_RowDataBound" OnPageIndexChanging="dtgCorRaca_PageIndexChanging">
