<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/MasterPage.master" AutoEventWireup="true" CodeFile="UsuarioEditar.aspx.cs" Inherits="Paginas_UsuarioEditar" %>
...
<asp:Content ID="Conteudo" ContentPlaceHolderID="Conteudo" Runat="Server">
    ...
    <div class="card">
         <div class="card-header">
                <h5 class="card-title"><asp:Label ID="lblTopo" runat="server"></asp:Label></h5>
              </div>
        <div class="row">
                            <div class="col-md">
        ...
        <div class="row">
            <div class="col-md">
                                <asp:Label ID="lblMsgSucesso" role="alert" Width="100%" runat="server" CssClass="alert alert-success"></asp:Label>
                            </div>
        </div>
         <div class="card-body">
                    ...
                    <div class="col-md-3 px-1" id="divCPF" runat="server">
                      <div class="form-group">
                        <label>CPF *</label>
                        <input onkeypress='Formatar(this, "###.###.###-##")' ID="txtCpf"
                                    class="form-control" type="text" MaxLength="14" size="12" name="txtCpf" runat="server"></input>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <label>E-mail</label>
                        <input ID="txtEmail"
                                    class="form-control" type="email" MaxLength="100" size="12" name="txtEmail" style='text-transform:uppercase' runat="server"></input>
                      </div>
                    </div>
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <asp:TextBox ID="txtSenha"
                                    CssClass="form-control" type="password" MaxLength="15" size="12" name="txtEmail" runat="server"></asp:TextBox>
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        ...
                        <asp:TextBox ID="txtConfirmacaoSenha"
                                    CssClass="form-control" type="password" MaxLength="15" size="12" name="txtConfirmacaoSenha" runat="server"></asp:TextBox>
                      </div>
                    </div>
                  </div>
                ...
                />
                              ...
                              <div id="divNomeCanil" class="form-group" runat="server">
                      ...
                      <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <asp:label ID="lblTipoAcesso" runat="server">Tipo de Acesso</asp:label>
