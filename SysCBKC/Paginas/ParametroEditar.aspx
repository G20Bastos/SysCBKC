<%@ Page Language="C#" MasterPageFile="~/Paginas/MasterPage.master" AutoEventWireup="true" CodeFile="ParametroEditar.aspx.cs" Inherits="Paginas_ParametroEditar" %>
               ...
               <div class="card-body">
                    <div class="row">
                            <div class="form-group col-6">
                                ...
                                <asp:TextBox ID="txtParametro" CssClass="form-control" MaxLength="200" style='text-transform:uppercase' runat="server"></asp:TextBox>
                            </div>
                        </div>
