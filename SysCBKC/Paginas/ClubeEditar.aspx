<%@ Page Language="C#"  MasterPageFile="~/Paginas/MasterPage.master" AutoEventWireup="true" CodeFile="ClubeEditar.aspx.cs" Inherits="Paginas_ClubeEditar" %>
               ...
               <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <asp:TextBox ID="txtNomClube" CssClass="form-control" runat="server" MaxLength="100"></asp:TextBox>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <asp:TextBox ID="txtDscEndereco" CssClass="form-control" runat="server" MaxLength="100"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label><asp:Label ID="lblDscBairro" runat="server" Text="Bairro*"></asp:Label></label>
                                <asp:TextBox ID="txtDscBairro" CssClass="form-control" runat="server" MaxLength="25"></asp:TextBox>
                            </div>

                            <div class="form-group col-md-6">
                                <label><asp:Label ID="lblNomCidade" runat="server" Text="Cidade*"></asp:Label></label>
                                <asp:DropDownList ID="drpCidade" CssClass="form-control" runat="server" AutoPostBack="true">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <label><asp:Label ID="Label1" runat="server" Text="Região"></asp:Label></label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <asp:TextBox ID="txtDscEmail" CssClass="form-control" runat="server" MaxLength="60"></asp:TextBox>
                            </div>
                            <div class="form-group col-md-6">
                                <label><asp:Label ID="lblDscEmailAdicional" runat="server" Text="Site"></asp:Label></label>
                                <asp:TextBox ID="txtDscSite" CssClass="form-control" runat="server" MaxLength="60"></asp:TextBox>
                            </div>
                        </div>
